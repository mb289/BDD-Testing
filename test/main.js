...
describe("About Arrays", function() {
    ...
    it("should create arrays", function() {
        var emptyArray = [0];
        expect(typeof(emptyArray)).to.equal [0];
    ...
    it("should slice arrays", function() {
        ...
        expect(array.slice(2, 20)).to.equal["butter","and","jelly"];
        expect(array.slice(3, 0)).to.equal[0];
        expect(array.slice(3, 100)).to.equal["and","jelly"];
    ...
    it("should know about shifting arrays", function() {
        ...
        expect(shiftedValue).to.equal[3,1,2];
        expect(array).to.equal[3,1,2];
    });
});
//--- your tests go here
